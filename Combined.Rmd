...
ggplot(by_season, aes(season2, fg_pct, fill=as.factor(championship))) + geom_col() + ggtitle("Accuracy by Season")+ xlab("Season") + ylab("FG %") +scale_fill_manual("championship", values = c("Ring" = "yellow", "Other" = "black"))
