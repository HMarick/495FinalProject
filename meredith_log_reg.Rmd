...
# work on grouping action_type and see if this makes a difference in the model
# do we want to include combined_shot_type and/or shot_type? - look at how these 
# affect the log loss values.

#action_type_to_keep <- c("Jump Shot", "Layup Shot")
#test <- test %>% 
 # mutate(action_type = ifelse(action_type %in% action_type_to_keep, action_type, "other"))
