...
```
Notice how as $k$ increases, the graph begins to level off around $K=495$. The large requirement for $k$ makes sense, given the size of our training set is nearly 26,000 observations. Below, we use $k=495$ to predict shot outcomes on the test set.
